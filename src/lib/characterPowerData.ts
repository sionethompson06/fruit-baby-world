...
const POWER_DATA: Record<string, CharacterPowerData> = {
  ...
  tiki: {
    ...
    powerProfileImage: "/characters/power-profiles/tiki-trouble-power-profile.webp",
  },
  "tiki-trouble": {
    powerName: "Trouble Trick™",
    powerDescription:
