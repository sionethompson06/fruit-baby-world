...
function ProductModal({
  ...
  return (
    ...
    >
      ...
      {/* Panel */}
      <div className="relative z-10 bg-white rounded-3xl shadow-2xl border border-tiki-brown/10 max-w-sm w-full flex flex-col overflow-hidden">
        {/* Close */}
        ...
        {/* Large image */}
        <div className="relative aspect-square mx-5 rounded-2xl overflow-hidden bg-gradient-to-br from-pineapple-yellow/10 via-bg-cream to-ube-purple/8 flex items-center justify-center">
          {item.imageUrl ? (
            // eslint-disable-next-line @next/next/no-img-element
            <img
              src={item.imageUrl}
