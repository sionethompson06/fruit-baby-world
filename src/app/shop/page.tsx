...
export default function ShopPage() {
  ...
  return (
    <div className="flex flex-col bg-bg-cream min-h-screen">
      ...
      {/* ── Hero ─────────────────────────────────────────────────────────────── */}
      <section className="bg-gradient-to-b from-ube-purple/15 via-bg-cream to-bg-cream pt-6 pb-4 px-4 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-sm font-semibold text-tiki-brown/70 max-w-lg mx-auto leading-relaxed mb-3">
